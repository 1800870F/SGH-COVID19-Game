...
public class QuestionManagerForWorkplace : MonoBehaviour
{
    public QuestionWorkplace[] questionsWork;
    private static List<QuestionWorkplace> unansweredQuestions;

    private QuestionWorkplace currentQuestion;
    ...
    public void SetQuestion()
    {
        ...
        {
            unansweredQuestions = questionsWork.ToList<QuestionWorkplace>();
        }
    ...
    public IEnumerator TransitionBackToBoard()
    {
        ...
        AchievementManager.Instance.EarnAchievement("Workplace Hygiene - Bronze");
