...
public class QuestionManagerForSocial : MonoBehaviour
{
    public QuestionSocial[] questionsSocial;
    private static List<QuestionSocial> unansweredQuestions;

    private QuestionSocial currentQuestion;
    ...
    public void SetQuestion()
    {
        ...
        {
            unansweredQuestions = questionsSocial.ToList<QuestionSocial>();
        }
    ...
    public IEnumerator TransitionBackToBoard()
    {
        ...
        AchievementManager.Instance.EarnAchievement("Social Distancing - Bronze");
