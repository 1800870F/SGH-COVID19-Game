...
public class QuestionManagerForDorm : MonoBehaviour
{
    public QuestionDorm[] questionsDorm;
    private static List<QuestionDorm> unansweredQuestions;

    private QuestionDorm currentQuestion;
    ...
    public void SetQuestion()
    {
        ...
        {
            unansweredQuestions = questionsDorm.ToList<QuestionDorm>();
        }
    ...
    public IEnumerator TransitionBackToBoard()
    {
        ...
        AchievementManager.Instance.EarnAchievement("Dormitory Hygiene - Bronze");
